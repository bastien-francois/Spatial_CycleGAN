...
datasetA, LON_France, LAT_France,_, _, IND_France, point_max, Original_tas = CycleGAN.load_RData_rank("tas_pr_day_SAFRANdet_79_16_France", "tas_day_SAFRANdet_79_16_France",Ind_season, region="France")


datasetA, LON_France, LAT_France,_,_, IND_France, point_max, Original_pr = CycleGAN.load_RData_rank("tas_pr_day_SAFRANdet_79_16_France","pr_day_SAFRANdet_79_16_France",Ind_season, region="France")
...
os.chdir("/gpfswork/rech/eal/commun/CycleGAN/Data/SAFRANdet/")
_, LON_Paris, LAT_Paris, _, _, IND_Paris, point_max, _ = CycleGAN.load_RData_rank("tas_pr_day_SAFRANdet_79_16_Paris", "tas_day_SAFRANdet_79_16_Paris", Ind_season, region = "Paris")
...
#np.savez('pr_day_SAFRANdetbili_79_16_Paris.npz', pr_day_SAFRANdetbili_79_16_Paris =  pr_day_SAFRANdetbili_79_16_Paris,  IND_Paris = IND_Paris, LON_Paris = LON_Paris, LAT_Paris = LAT_Paris, point_max = point_max)
...
#
#pyplot.imshow(New_Paris)
#pyplot.subplot(2, 1, 2)
#
#pyplot.imshow(OriginalParisLarge[100,:,:])
#
#
#pyplot.show()
#
...
##### Load IPSL
#os.chdir("/gpfswork/rech/eal/commun/CycleGAN/Data/SAFRANdet/")
#datasetP, LON_P, LAT_P, XminA_, XmaxA_, IND_P, point_max, OriginalP = CycleGAN.load_RData_rank("tas_pr_day_SAFRANdet_79_16_Paris",var_phys + "_day_SAFRANdet_79_16_Paris",Ind_season, r
#egion="Paris")
#
#
#
